...
Används vid exportering av datan 
<br>
...
Däremot har jag märkt att kopiera till clipboard inte funkar på alla mobil-webbläsarna DuckDuckGo och Safari. Antar att det är denna rad som antingen är blockerad funktion eller ser annorlunda ut
<br>
